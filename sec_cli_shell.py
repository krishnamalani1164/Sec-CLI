...
def run_ai_logic(prompt_text, current_os=current_os):
    ...
    prompt_with_os = f"[OS: {current_os}]\n{prompt_text}"
    result = backend_inst.process_prompt(prompt_text, current_os=current_os)
